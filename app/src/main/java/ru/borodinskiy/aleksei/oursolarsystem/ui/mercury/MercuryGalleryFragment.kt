...
class MercuryGalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = GalleryAdapter(object : GalleryListener {
            ...
            override fun onFullImage(image: Image) {
                val bundle = bundleOf(
                    ...
                    Pair("nameRus", getString(R.string.menu_mercury))
                )
                findNavController().navigate(R.id.action_nav_mercury_to_fullImageFragment, bundle)
            }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            viewModel.getImagesFromKeyWord("Mercurius").observe(viewLifecycleOwner) { images ->
                images.let {
