...
@AndroidEntryPoint
class DwarfPlanetInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = SatelliteAdapter(object : SatelliteListener {
            ...
            override fun onShowDetail(satellite: Satellite) {
                ...
                findNavController().navigate(R.id.action_nav_dwarf_planets_to_singleSatelliteFragment, bundle)
            }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.getSatelliteFromPlanet("Dwarf planet").observe(viewLifecycleOwner) { planets ->
                planets.let {
