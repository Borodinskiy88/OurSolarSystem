...
@AndroidEntryPoint
class SaturnPlanetGalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = GalleryAdapter(object : GalleryListener {
            ...
            override fun onFullImage(image: Image) {
                val bundle = bundleOf(
                    ...
                    Pair("nameRus", getString(R.string.menu_saturn))
                )
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            viewModel.getImagesFromKeyWord("Saturnus").observe(viewLifecycleOwner) { images ->
                images.let {
