...
import ru.borodinskiy.aleksei.oursolarsystem.adapter.viewpager.JupiterGalleryViewPagerAdapter
...
class JupiterGalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.viewPager.adapter = JupiterGalleryViewPagerAdapter(childFragmentManager, lifecycle)
        TabLayoutMediator(binding.tabLayout, binding.viewPager) { tab, position ->
            val feedList = listOf(
                getString(R.string.menu_jupiter),
