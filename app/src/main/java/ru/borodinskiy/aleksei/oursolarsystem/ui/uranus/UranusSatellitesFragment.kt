    ...
    override fun onCreateView(
        ...
        val adapter = SatelliteAdapter(object : SatelliteListener {
            ...
            override fun onShowDetail(satellite: Satellite) {
                ...
                findNavController().navigate(R.id.action_nav_uranus_to_singleSatelliteFragment, bundle)
            }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.getSatelliteFromPlanet("Uranus").observe(viewLifecycleOwner) { planets ->
                planets.let {
