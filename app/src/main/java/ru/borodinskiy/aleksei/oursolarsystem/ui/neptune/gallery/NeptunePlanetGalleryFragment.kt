...
@AndroidEntryPoint
class NeptunePlanetGalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = GalleryAdapter(object : GalleryListener {
            ...
            override fun onFullImage(image: Image) {
                val bundle = bundleOf(
                    ...
                    Pair("nameRus", getString(R.string.menu_neptune))
                )
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            viewModel.getImagesFromKeyWord("Neptunus").observe(viewLifecycleOwner) { images ->
                images.let {
