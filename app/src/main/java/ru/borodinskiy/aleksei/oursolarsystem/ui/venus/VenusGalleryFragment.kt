...
class VenusGalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = GalleryAdapter(object : GalleryListener {
            ...
            override fun onFullImage(image: Image) {
                val bundle = bundleOf(
                    ...
                    Pair("nameRus", getString(R.string.menu_venus))
                )
                findNavController().navigate(R.id.action_nav_venus_to_fullImageFragment, bundle)
            }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            viewModel.getImagesFromKeyWord("Venus").observe(viewLifecycleOwner) { images ->
                images.let {
