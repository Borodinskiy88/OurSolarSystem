    ...
    override fun onCreateView(
        ...
        val adapter = SatelliteAdapter(object : SatelliteListener {
            ...
            override fun onShowDetail(satellite: Satellite) {
                ...
                findNavController().navigate(R.id.action_nav_jupiter_to_singleSatelliteFragment, bundle)
            }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.getSatelliteFromPlanet("Jupiter").observe(viewLifecycleOwner) { planets ->
                planets.let {
