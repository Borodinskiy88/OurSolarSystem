...
@AndroidEntryPoint
class JupiterPlanetGalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = GalleryAdapter(object : GalleryListener {
            ...
            override fun onFullImage(image: Image) {
                val bundle = bundleOf(
                    ...
                    Pair("nameRus", getString(R.string.menu_jupiter))
                )
                findNavController().navigate(R.id.action_nav_jupiter_to_fullImageFragment, bundle)
            }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            viewModel.getImagesFromKeyWord("Jupiter").observe(viewLifecycleOwner) { images ->
                images.let {
