...
@AndroidEntryPoint
class NeptuneSatelliteGalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = GalleryAdapter(object : GalleryListener {
            ...
            override fun onFullImage(image: Image) {
                val bundle = bundleOf(
                    ...
                    Pair("nameRus", getString(R.string.neptunus_satellites))
                )
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            viewModel.getImagesFromKeyWord("Neptunus Satellites").observe(viewLifecycleOwner) { images ->
                images.let {
