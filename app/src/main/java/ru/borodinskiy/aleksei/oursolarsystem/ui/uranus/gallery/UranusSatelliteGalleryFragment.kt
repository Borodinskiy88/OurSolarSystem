...
@AndroidEntryPoint
class UranusSatelliteGalleryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = GalleryAdapter(object : GalleryListener {
            ...
            override fun onFullImage(image: Image) {
                val bundle = bundleOf(
                    ...
                    Pair("nameRus", getString(R.string.uranus_satellite))
                )
                findNavController().navigate(R.id.action_nav_uranus_to_fullImageFragment, bundle)
            }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            viewModel.getImagesFromKeyWord("Uranus Satellites").observe(viewLifecycleOwner) { images ->
                images.let {
